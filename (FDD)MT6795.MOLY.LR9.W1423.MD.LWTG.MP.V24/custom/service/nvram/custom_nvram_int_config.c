...
#endif
    {
        ...
        if (sbp_id != 0)
        {
...
#if defined (__MOD_IMC__)
                { /* IMS VoLTE overwrite for CMCC (op01) */
                    ...
                    /* overwrite here */
                    /*=================================================================*/
                    imc_profile.ua_config.operator_code            = 0x0001;      //operator_code = 1(CMCC)
                    imc_profile.ua_config.UA_call_rej_by_user_code = 603;
                    imc_profile.ua_config.UA_call_no_resource_code = 580;
                    imc_profile.ua_config.UA_reg_ipsec_algo        = 0x3f;
                    imc_profile.imc_config.resouce_retain_timer   = 0x00001770;  // 6000ms (6 seconds) 
					/*==================================================================*/
            ...
            else if (sbp_id == 5) //for DTAG
            {
			    ...
			    kal_uint8 buf_utra_cap[NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE];
                nvram_ef_umts_usime_rrc_dynamic_struct* pUtra_cap;
			    #endif
                kal_uint8 buf_eutra_cap_csfb[NVRAM_EF_UE_EUTRA_CAP_CSFB_SIZE];
                kal_uint8 buf_eutra_cap_mmdc[NVRAM_EF_UE_EUTRA_CAP_MMDC_SIZE];
                ...
                pUtra_cap = (nvram_ef_umts_usime_rrc_dynamic_struct*)buf_utra_cap;
                pUtra_cap->r7_cap2 &= 0xFE;  //set r7_cap2 bit 1 to 0
                pUtra_cap->r8_cap1 &= 0xF7;  //set r8_cap1 bit 4 to 0
                pUtra_cap->r8_cap2 &= 0x7F;  //set r8_cap2 bit 8 to 0
                nvram_external_write_data(NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_LID,
                                        1,
                                        buf_utra_cap,
                                        NVRAM_EF_UMTS_USIME_RRC_DYNAMIC_CAP_SIZE);
            ...
            else if (sbp_id == 8) //for T-Mobile
            {
                ...
                { /* IMS VoLTE overwrite for TMO (op08) */
                    ...
                    imc_profile.ua_config.UA_call_def_max_ptime = 80;
                    imc_profile.ua_config.UA_reg_t1_timer = 0x000001F4; // 500 ms
                    imc_profile.ua_config.UA_reg_t2_timer = 0x00000FA0; // 4000 ms
                    imc_profile.ua_config.UA_reg_t4_timer = 0x00001388; // 5000 ms
