...
{
   /* Set 0: MT6795 INT phone Original(same as K95_UMTS_FDD_MT6169_V2)*/
   {
...
Ul1CustomDynamicInitUmtsBpiData ul1CustomUmtsBpiData[UL1CUSTOM_TOTAL_SET_NUMS][UL1CUSTOM_MAX_RF_SUPPORT_BAND_NUM] =
{
   /* Set 0: MT6795 INT phone Original(same as K95_UMTS_FDD_MT6169_V2)*/
   {
      /* Sub-index 0 */
      {
         ...
         {0x00120810,  0x00120810,  0x00120810,  0x00000000,  0x00000000,  0x00120810,  0x00120810,  0x00120810,  0x00000000,  0x00000000,  0x00120810,  0x00120810,  0x00120810,  0x00000000,  0x00000000 },
      },
      ...
      /* Sub-index 1 */
      {
         ...
         // BPI logics
         //PR1         PR2          PR2B         PR3          PR3A         PT1          PT2          PT2B         PT3          PT3A         RXD_PR1      RXD_PR2      RXD_PR2B     RXD_PR3      RXD_PR3A
         {0x0011C010,  0x0011C010,  0x0011C010,  0x00000000,  0x00000000,  0x0011C010,  0x0011C010,  0x0011C010,  0x00000000,  0x00000000,  0x0011C010,  0x0011C010,  0x0011C010,  0x00000000,  0x00000000 },
      },
      ...
      /* Sub-index 3 */
      {
         ...
         // BPI logis
         //PR1         PR2          PR2B         PR3          PR3A         PT1          PT2          PT2B         PT3          PT3A         RXD_PR1      RXD_PR2      RXD_PR2B     RXD_PR3      RXD_PR3A
         {0x00134008,  0x00134008,  0x00134008,  0x00000000,  0x00000000,  0x00134008,  0x00134008,  0x00134008,  0x00000000,  0x00000000,  0x00134008,  0x00134008,  0x00134008,  0x00000000,  0x00000000 },
      },
      /* Sub-index 4 */
      {
         UMTSBand8,
         // BPI logics
         //PR1         PR2          PR2B         PR3          PR3A         PT1          PT2          PT2B         PT3          PT3A         RXD_PR1      RXD_PR2      RXD_PR2B     RXD_PR3      RXD_PR3A
         {0x00111000,  0x00111000,  0x00111000,  0x00000000,  0x00000000,  0x00111000,  0x00111000,  0x00111000,  0x00000000,  0x00000000,  0x00111000,  0x00111000,  0x00111000,  0x00000000,  0x00000000 },
      }
   },

   /* Second Set, Set 1: SKU2 */
   {
      /* Sub-index 0 */
      {
         UMTSBand1,
...
Ul1CustomDynamicInitMipiData ul1CustomMipiData[UL1CUSTOM_TOTAL_SET_NUMS] =
{
   /* The first set, Set 0 : Original */
   {
        MIPI_DEFAULT/*Do Nothing, Just apply default from custom file*/
       ,NULL        //UMTS_MIPI_INITIAL_CW;
       ,NULL        //UMTS_MIPI_SLEEP_CW;
       ,NULL        //UMTS_MIPI_RX_EVENT_TABLE;
       ,NULL        //UMTS_MIPI_RX_DATA_TABLE;
       ,NULL        //UMTS_MIPI_TX_EVENT_TABLE;
       ,NULL        //UMTS_MIPI_TX_DATA_TABLE;
       ,NULL        //UMTS_MIPI_TPC_TABLE;
