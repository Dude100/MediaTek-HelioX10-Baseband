...
#if ( defined (MT6572) || defined (MT6582) || defined (MT6290) || defined(MT6595) || defined(MT6795)) && defined (MT6169_RF) 
#ifdef MIPI_SUPPORT_ENABLE
#define SKY77621
#else
#define SKY77590
...
#if ( defined (MT6572) || defined (MT6582)  || defined (MT6290) || defined(MT6595)) && defined (MT6169_RF) 
#if defined (SKY77590)
 /*--------------------------------------------------------*/
 /*           bit   pin                                    */
 /*            0    GPCTRL0                                */                                     
