 ...
 * Description:
 * ------------
 *   Custom MPU region setting for MT6290
 *
 * Author:
 * -------
 * -------
...
X_MPU_PREINIT_REGION(    MDSYS_APB_DEV,    0x80000000,            RGN_SIZE_2GB,       MPU_DEVICE_INNS_OUTDEV|MPU_PRW_URW|MPU_XN,          1                 )
X_MPU_PREINIT_REGION(    MDSYS_TCM,           0xBF000000,            RGN_SIZE_512KB,    MPU_NORMAL_INNC_OUTNC|MPU_PRW_URW,                        1                 )
X_MPU_PREINIT_REGION(    MDSYS_SPI,            0xA0000000,            RGN_SIZE_128MB,    MPU_NORMAL_INNC_OUTNC|MPU_PR_UR,                              1                 )
X_MPU_PREINIT_REGION(    MDSYS_APB_SO,     0xF0000000,            RGN_SIZE_256MB,    MPU_SOM|MPU_PRW_URW|MPU_XN,                                      1                 )
...
X_MPU_INIT_REGION(    MDSYS_APB_DEV,          0x80000000,           1<<(RGN_SIZE_2GB+1),         MPU_DEVICE_INNS_OUTDEV|MPU_PRW_URW|MPU_XN,     1)
X_MPU_INIT_REGION(    MDSYS_TCM,                 0xBF000000,           1<<(RGN_SIZE_512KB+1),      MPU_NORMAL_INNC_OUTNC|MPU_PRW_URW,                   1)
X_MPU_INIT_REGION(    MDSYS_SPI,                   0xA0000000,          1<<(RGN_SIZE_128MB+1),      MPU_NORMAL_INNC_OUTNC|MPU_PR_UR,                         1)
X_MPU_INIT_REGION(    MDSYS_APB_SO,            0xF0000000,          1<<(RGN_SIZE_256MB+1),      MPU_SOM|MPU_PRW_URW|MPU_XN,                                 1)
