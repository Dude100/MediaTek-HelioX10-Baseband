...
SRC_LIST = $(strip $(MODEM_FOLDER))/smt/uesim_lte/gsim_nw/src/m133000.c \
					 $(strip $(MODEM_FOLDER))/smt/uesim_lte/gsim_nw/src/m133001.c \
					 $(strip $(MODEM_FOLDER))/smt/uesim_lte/gsim_nw/src/m133002.c \
					 $(strip $(MODEM_FOLDER))/smt/uesim_lte/gsim_nw/src/m133003.c \
					 $(strip $(MODEM_FOLDER))/smt/uesim_lte/gsim_nw/src/m133004.c
...
SRC_PATH = $(strip $(MODEM_FOLDER))/smt/uesim_lte/gsim_nw/src
