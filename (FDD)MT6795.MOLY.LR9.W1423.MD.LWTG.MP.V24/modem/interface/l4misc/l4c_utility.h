...
extern kal_bool is_rac_tcm_cmd_conflict(kal_uint8 src_id, kal_uint8 action);

extern kal_bool is_smu_cmd_conflict(kal_uint8 src_id, kal_uint8 action);

extern l4c_gprs_cmd_conflict_cause_enum is_tcm_cmd_conflict(kal_uint8 cid, kal_uint8 src_id, kal_uint8 action);

extern l4c_gprs_cmd_conflict_cause_enum is_tcm_cmd_conflict_basic(kal_uint8 cid, kal_uint8 src_id, kal_uint8 action); //maui_01895693, mtk02285
