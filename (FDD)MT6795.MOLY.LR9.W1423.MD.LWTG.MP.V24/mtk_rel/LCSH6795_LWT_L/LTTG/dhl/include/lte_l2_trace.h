...
#include "L1Trc.h"
	...
	#define L2_DRV_INFO(v1, v2, v3, v4) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x012C | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define L2_EVT_NOT_SUPPORT(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x052C | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_INIT_FAIL(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x062C | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_LMAC_RAR_CB_FAIL(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x072C | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_LMAC_UL_EVT_CB_FAIL(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x092C | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_DL_EVT_CB_FAIL(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0A2C | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_DL_ERR_CB_FAIL(v1, v2, v3, v4) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x0C2C | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define L2_LMAC_GENERAL_ERR(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x102C | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_LMAC_UL_UNDERRUN_WARN(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x112C | ((short)(v1) << 16));\
	} while(0)
#else
