...
#define L1I_Msg_TimerExecute_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1E1D, (unsigned char)(v1), (unsigned char)(v2)))
	...
	#define L1I_Msg_ServingSBPeek(v1, v2, v3) do {\
		if(L1C_GSM_Trace_Filter[0]==1 && (L1C_GSM_Trace_Filter[4]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1F1D, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1I_Msg_ServingSBPeek(v1, v2, v3)
#endif
#define L1I_Msg_ServingSBPeek_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1F1D, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
