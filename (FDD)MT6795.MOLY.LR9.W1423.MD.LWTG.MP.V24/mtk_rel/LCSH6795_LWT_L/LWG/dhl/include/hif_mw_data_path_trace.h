...
#include "L1Trc.h"
	...
	#define CCMNI_DL_DATA_PACKET_TRACE(v1, v2, v3, v4) do {\
		if(HIF_MW_Trace_Filter[0]==1 && (HIF_MW_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x411A | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define CCMNI_UL_DATA_PACKET_TRACE(v1, v2, v3, v4) do {\
		if(HIF_MW_Trace_Filter[0]==1 && (HIF_MW_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x421A | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define CCMNI_UL_GPD_IN_HIF(v1, v2, v3, v4, v5) do {\
		if(HIF_MW_Trace_Filter[0]==1 && (HIF_MW_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_5_word(0x431A | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4), (long)(v5));\
	} while(0)
#else
	...
	#define CCMNI_UL_RELOAD_RGPD(v1, v2, v3, v4) do {\
		if(HIF_MW_Trace_Filter[0]==1 && (HIF_MW_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x441A | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define CCMNI_MAX_RELOAD_RGPD_IN_HIF(v1, v2, v3) do {\
		if(HIF_MW_Trace_Filter[0]==1 && (HIF_MW_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x461A | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define CCMNI_DEVICE_STATUS(v1, v2, v3, v4) do {\
		if(HIF_MW_Trace_Filter[0]==1 && (HIF_MW_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x471A | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define CCCITTY_DATA_DUMP_TRACE(v1, v2, v3, v4, v5) do {\
		if(HIF_MW_Trace_Filter[0]==1 && (HIF_MW_Trace_Filter[1]&0x80)!=0 )\
			l2trc_send_5_word(0x481A | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
