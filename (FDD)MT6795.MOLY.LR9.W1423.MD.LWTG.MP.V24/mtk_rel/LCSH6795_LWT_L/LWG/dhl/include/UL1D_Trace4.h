...
#define UL1D_TRC_QUERY_DAC_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2431, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
	...
	#define UL1D_TRC_DFTC_SET_RXNCO(v1, v2, v3) do {\
		if(UL1D_FIFTH_Trace_Filter[0]==1 && (UL1D_FIFTH_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x2531, (short)(v2)), TRC_MERGE_1S2C((short)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1));\
	} while(0)
#else
	#define UL1D_TRC_DFTC_SET_RXNCO(v1, v2, v3)
#endif
#define UL1D_TRC_DFTC_SET_RXNCO_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2531, (short)(v2)), TRC_MERGE_1S2C((short)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
