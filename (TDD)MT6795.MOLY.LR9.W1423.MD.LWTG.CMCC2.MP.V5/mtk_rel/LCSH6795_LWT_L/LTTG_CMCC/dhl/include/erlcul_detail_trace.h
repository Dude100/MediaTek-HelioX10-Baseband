...
#include "L1Trc.h"
	...
	#define ERLC_LOG_1ST_RND_IN(v1, v2, v3) do {\
		if(ERLCUL_DETAIL_Trace_Filter[0]==1 && (ERLCUL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x0009 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ERLC_LOG_1ST_RND_OUT(v1, v2, v3) do {\
		if(ERLCUL_DETAIL_Trace_Filter[0]==1 && (ERLCUL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x0109 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ERLC_LOG_2ND_RND_IN(v1, v2, v3, v4) do {\
		if(ERLCUL_DETAIL_Trace_Filter[0]==1 && (ERLCUL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x0309 | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define ERLC_LOG_AM_REL_SN_ADV(v1, v2, v3) do {\
		if(ERLCUL_DETAIL_Trace_Filter[0]==1 && (ERLCUL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x0509 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ERLC_LOG_UL_HWB_REL(v1, v2, v3, v4) do {\
		if(ERLCUL_DETAIL_Trace_Filter[0]==1 && (ERLCUL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x0709 | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define ERLC_LOG_UL_RESRV_PST(v1, v2) do {\
		if(ERLCUL_DETAIL_Trace_Filter[0]==1 && (ERLCUL_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0809 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ERLC_LOG_UL_WRITE_PST(v1, v2, v3) do {\
		if(ERLCUL_DETAIL_Trace_Filter[0]==1 && (ERLCUL_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0909 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
