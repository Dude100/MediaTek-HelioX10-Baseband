...
#include "L1Trc.h"
	...
	#define TrcQBM_InitByCfg1(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0014 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_InitByCfg2(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x0114 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_AllocQueueStr(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_4_word(0x0214 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_AllocQueueEnd(v1, v2, v3, v4, v5) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_5_word(0x0314 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define TrcQBM_AllocOne(v1, v2, v3) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x0414 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define TrcQBM_FreeQueue(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x0514 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_FreeOne(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_2_word(0x0614 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_FreeQ_Str(v1, v2, v3) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_3_word(0x0714 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define TrcQBM_FreeQ_End(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_4_word(0x0814 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_AllocFromFLC(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_2_word(0x0914 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define TrcQBM_Rel2FLCStr(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_2_word(0x0A14 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_Rel2FLCEnd(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_2_word(0x0B14 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_ReloadFromFLC(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_4_word(0x0C14 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_EnQCommon(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[1]&0x80)!=0 )\
			l2trc_send_4_word(0x0D14 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_EnQWthBypass(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x01)!=0 )\
			l2trc_send_4_word(0x0E14 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_EnQCommonRx(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x02)!=0 )\
			l2trc_send_4_word(0x0F14 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_DeQ(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x04)!=0 )\
			l2trc_send_2_word(0x1014 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_DeQTx(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x08)!=0 )\
			l2trc_send_4_word(0x1114 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_DeQHIF_UL_Str(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x08)!=0 )\
			l2trc_send_4_word(0x1214 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define TrcQBM_DeQHIF_UL_End(v1, v2, v3, v4, v5) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x04)!=0 )\
			l2trc_send_5_word(0x1314 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define TrcQBM_SetExtParam(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x10)!=0 )\
			l2trc_send_2_word(0x1414 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_GetRemain(v1, v2) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x10)!=0 )\
			l2trc_send_2_word(0x1514 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define TrcQBM_GetRemainFLC_Chk(v1, v2, v3) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x20)!=0 )\
			l2trc_send_3_word(0x1614 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define TrcQBM_PoolStatus(v1, v2, v3, v4) do {\
		if(QMU_BM_Trace_Filter[0]==1 && (QMU_BM_Trace_Filter[2]&0x10)!=0 )\
			l2trc_send_3_word(0x1714 | ((short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)((char)(v4))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
