...
#include "L1Trc.h"
	...
	#define EMAC_LOG_TIMER_START(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x000D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_GET_HARQ(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x010D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_TTI_GET_HARQ(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x020D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_REQ_DATA(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x030D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CE_LBSR(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x050D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CE_PHR(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x070D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_STATUS_IND(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x080D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DATA_REQ(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x090D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DATA_REQ2(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x0A0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLOSS_SSID(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0B0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLR_TX_TL(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x0C0D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DUP_RETX_INFO(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x0E0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_RETX_TMR_START(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x0F0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_PERI_TMR_START(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_1_word(0x100D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_INCLUDE(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x110D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_TRIGGER(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x120D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_BSR_LCG_STATUS(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x130D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SET_LONG_BSR(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x140D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SET_TRU_BSR(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x160D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_RETX_INFO0(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x170D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_RETX_INFO2(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x190D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_HT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x1A0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EAMC_LOG_DL_ASSIGNMENT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x1B0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_SWO(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x1C0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_LAST_ACTIVE_SUBFRAME(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x1D0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_STATUS(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1E0D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_TIME_TO_HARQ(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x1F0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_TIME_TO_PDCCH(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x200D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_TIME_TO_RTT_TMR(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x210D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_HOST_WAKEUP(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x220D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_DRX_LOG_UPDATE_T_PDCCH(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x230D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_SR_UPDATE_WAKE_TIME(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x240D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_HARQ_UPDATE_WAKE_TIME(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x250D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_SPS_UPDATE_WAKE_TIME(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x260D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_WAKE_DRX_CYCLE(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x270D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_PUSCH_UPDATE_WAKE_TIME(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x280D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHK_PUSCH_GRANT(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x290D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHK_PUSCH_NACK(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x2A0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHK_PUSCH_HARQ(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x2B0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_SR_SUSPEND_DRX(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x2D0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_SUSPEND_DRX(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x2E0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHK_WAKE(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x2F0D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLOSE_RESV_HARQ(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x310D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SCH_RESV_ADP_RETX(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x320D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SCH_RESV_NON_ADP_RETX(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x330D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_REQ_IN_GEMINI_GAP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x340D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_PDCCH_MAY_BE_IN_GAP(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x350D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_GEMINI_GAP_RX_START(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x370D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_GEMINI_GAP_RX_END(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x380D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SET_GEMINI_PHICH(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x390D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_JUDGE_RETX_MODE(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x3B0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_TX_SKIP_FOR_GAP(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x3C0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_UPDATE_G_GAP(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x3D0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_SKIP_FOR_G_GAP(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x3E0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_NOT_SKIP_TX_NB(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x400D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_DISABLE_PHICH(v1, v2, v3) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x410D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_REPORT(v1, v2, v3, v4) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x420D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_VOLTE_REPORT_TIMING(v1, v2) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x450D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_TX_CLOSE_INVALID_SSID(v1) do {\
		if(EMAC_DETAIL_Trace_Filter[0]==1 && (EMAC_DETAIL_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x460D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
