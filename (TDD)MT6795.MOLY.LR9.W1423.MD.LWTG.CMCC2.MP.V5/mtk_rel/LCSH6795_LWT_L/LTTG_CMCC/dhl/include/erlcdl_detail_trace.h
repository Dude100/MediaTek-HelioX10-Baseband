...
#include "L1Trc.h"
	...
	#define ERLC_LOG_REASM_ENTRY_1(v1, v2, v3) do {\
		if(ERLCDL_DETAIL_Trace_Filter[0]==1 && (ERLCDL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x000B | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define ERLC_LOG_REASM_ENTRY_1E(v1, v2, v3, v4) do {\
		if(ERLCDL_DETAIL_Trace_Filter[0]==1 && (ERLCDL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x010B | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define ERLC_LOG_REASM_ENTRY_2(v1, v2) do {\
		if(ERLCDL_DETAIL_Trace_Filter[0]==1 && (ERLCDL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x020B | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ERLC_LOG_REASM_ENTRY_FIN(v1, v2, v3, v4) do {\
		if(ERLCDL_DETAIL_Trace_Filter[0]==1 && (ERLCDL_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x030B | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define ERLC_LOG_DL_RESRV_PST(v1, v2) do {\
		if(ERLCDL_DETAIL_Trace_Filter[0]==1 && (ERLCDL_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x070B | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define ERLC_LOG_DL_WRITE_PST(v1, v2, v3) do {\
		if(ERLCDL_DETAIL_Trace_Filter[0]==1 && (ERLCDL_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x080B | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
