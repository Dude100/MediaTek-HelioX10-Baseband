...
#include "L1Trc.h"
	...
	#define DUMMY_EDYN_LOG(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x0010 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EINIT_TIME(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_4_word(0x0110 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define SHOW_LTE_TICK(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0210 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ENTER_DSP_TIMER_LISR(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_3_word(0x0310 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ENTER_LMAC_HNDLR(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0410 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define DSP_EVENT_LISR(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0510 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define LTM_RESET_EPSB(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x0610 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define LTM_CONSTRUCT_UL_SDU(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x0710 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define LTM_QUEUE_UL_SDU(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_3_word(0x0910 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define LTM_PROCESS_EPSB_UL_Q(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x0A10 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define LTM_PROCESS_EPSB_DL(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_4_word(0x0B10 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define LTM_ROLLBACK(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x0C10 | ((short)(v1) << 16), (long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define LTM_NXT_DRX_IND(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x0D10 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_EPSB_INIT(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x0E10 | ((short)(v1) << 16), (kal_uint32)((char)(v4)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define LTM_EPSB_ACT(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x0F10 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_EPSB_DEACT(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1010 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_IDLE_ENTER(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1110 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_IDLE_ENTER_CHECK(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_2_word(0x1210 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define LTM_IDLE_LEAVE(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_3_word(0x1310 | ((short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v2));\
	} while(0)
#else
	...
	#define LTM_IDLE_LEAVE_REJ(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1410 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_IDLE_LEAVE_REJ_DROP(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1510 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_SUSPEND(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1610 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_RESUME(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1710 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_GEMINI_SUSPEND(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1810 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_GEMINI_RESUME(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1910 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define ETMR_Timeout(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x1A10 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((short)(v3))) << 16), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Resume(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x1B10 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Stop(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x1C10 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Init(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x1D10 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((short)(v3))) << 16), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_SetAttri(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x1E10 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((short)(v3))) << 16), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Set(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x1F10 | ((short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)((char)(v2))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Fail(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2010 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ETMR_TickByTicks(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_1_word(0x2110 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ETMR_GetLatestExpire(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_1_word(0x2210 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ETMR_ExpireEnd(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2310 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ETMR_InitMayFail(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2410 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)((short)(v4))) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_OFF_TO_ON(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2510 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_ON_TO_OFF(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2610 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_ON_TO_WAIT_OFF(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2710 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_WAIT_OFF_TO_OFF(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2810 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_WAIT_OFF_TO_ON(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2910 | ((short)(v1) << 16));\
	} while(0)
#else
