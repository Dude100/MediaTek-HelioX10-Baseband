...
#include "L1Trc.h"
	...
	#define MODEM_TOPSM_EMI_REQUEST(v1, v2, v3) do {\
		if(MODEM_TOPSM_1_Trace_Filter[0]==1 && (MODEM_TOPSM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0047, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3));\
	} while(0)
#else
	#define MODEM_TOPSM_EMI_REQUEST(v1, v2, v3)
#endif
#define MODEM_TOPSM_EMI_REQUEST_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0047, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3))

#if defined(L1_CATCHER)
	#define MODEM_TOPSM_TRC_CALIBRATION(v1, v2, v3) do {\
		if(MODEM_TOPSM_1_Trace_Filter[0]==1 && (MODEM_TOPSM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0147, (unsigned short)(v1)), (long)(v2), (long)(v3));\
	} while(0)
#else
	#define MODEM_TOPSM_TRC_CALIBRATION(v1, v2, v3)
#endif
#define MODEM_TOPSM_TRC_CALIBRATION_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0147, (unsigned short)(v1)), (long)(v2), (long)(v3))
