...
#include "L1Trc.h"
	...
	#define HIF_SRV_DUMMY(v1) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x001A | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define HMU_DATA_EVENT_TRIGGER(v1, v2, v3) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x011A | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define CCCI_WRITE_GPD_RET_DATA_TRACE(v1, v2, v3, v4) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x031A | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define CCCI_ULIOR_CB_DATA_TRACE(v1, v2, v3, v4, v5) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_5_word(0x041A | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define CCCI_ULBUFF_CB_DATA_TRACE(v1, v2, v3, v4, v5) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_5_word(0x051A | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define CCCI_DATA_DUMP_TRACE(v1, v2, v3, v4, v5, v6, v7) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_7_word(0x061A | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
	...
	#define CCCI_IMS_DATA_DUMP_TRACE(v1, v2, v3, v4, v5, v6) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_6_word(0x071A | ((short)(v1) << 16), (long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6));\
	} while(0)
#else
	...
	#define CCCI_FS_DATA_DUMP_TRACE(v1, v2, v3, v4, v5, v6, v7) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x80)!=0 )\
			l2trc_send_7_word(0x081A | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
	...
	#define CCCI_DEBUG_CHECK_SEQ_TRACE(v1, v2, v3, v4, v5) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[2]&0x01)!=0 )\
			l2trc_send_5_word(0x0A1A | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
