...
#include "L1Trc.h"
	...
	#define UMAC_TRC_UPARAW(v1, v2, v3, v4) do {\
		if(UMAC_Trace_Filter[0]==1 && (UMAC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x003E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UMAC_TRC_UPARAW(v1, v2, v3, v4)
#endif
#define UMAC_TRC_UPARAW_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x003E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UMAC_HSDSCH_BLOCK_GET_INFO_A(v1) do {\
		if(UMAC_Trace_Filter[0]==1 && (UMAC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x013E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define UMAC_HSDSCH_BLOCK_GET_INFO_A(v1)
#endif
#define UMAC_HSDSCH_BLOCK_GET_INFO_A_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x013E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UMAC_HSDSCH_BLOCK_GET_INFO_B(v1) do {\
		if(UMAC_Trace_Filter[0]==1 && (UMAC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x023E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define UMAC_HSDSCH_BLOCK_GET_INFO_B(v1)
#endif
#define UMAC_HSDSCH_BLOCK_GET_INFO_B_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x023E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UMAC_HSDSCH_BLOCK_FREE_INFO_B(v1) do {\
		if(UMAC_Trace_Filter[0]==1 && (UMAC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x033E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define UMAC_HSDSCH_BLOCK_FREE_INFO_B(v1)
#endif
#define UMAC_HSDSCH_BLOCK_FREE_INFO_B_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x033E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UMAC_HSDSCH_BLOCK_FREE_NUM_B(v1, v2) do {\
		if(UMAC_Trace_Filter[0]==1 && (UMAC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x043E, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define UMAC_HSDSCH_BLOCK_FREE_NUM_B(v1, v2)
#endif
#define UMAC_HSDSCH_BLOCK_FREE_NUM_B_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x043E, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
