...
#include "L1Trc.h"
	...
	#define URLC_TRC_GETBO(v1) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x003D, (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_GETBO(v1)
#endif
#define URLC_TRC_GETBO_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x003D, (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_ZERO_BO() do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x013D, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_ZERO_BO()
#endif
#define URLC_TRC_ZERO_BO_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x013D, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_SELECT_SUFI(v1, v2, v3, v4) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x023D, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_SELECT_SUFI(v1, v2, v3, v4)
#endif
#define URLC_TRC_SELECT_SUFI_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x023D, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_SCHEDULE_ACK(v1, v2) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x033D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_SCHEDULE_ACK(v1, v2)
#endif
#define URLC_TRC_SCHEDULE_ACK_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x033D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_TRANSMIT_AM(v1, v2, v3) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x043D, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_TRANSMIT_AM(v1, v2, v3)
#endif
#define URLC_TRC_TRANSMIT_AM_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x043D, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_TRANSMIT_UM(v1, v2) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x053D, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_TRANSMIT_UM(v1, v2)
#endif
#define URLC_TRC_TRANSMIT_UM_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x053D, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_TRANSMIT_TM(v1) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x063D, (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_TRANSMIT_TM(v1)
#endif
#define URLC_TRC_TRANSMIT_TM_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x063D, (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_TRANSMIT_AM_SN(v1, v2) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x073D, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define URLC_TRC_TRANSMIT_AM_SN(v1, v2)
#endif
#define URLC_TRC_TRANSMIT_AM_SN_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x073D, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_RETRANSMIT_AM_SN(v1, v2) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x083D, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define URLC_TRC_RETRANSMIT_AM_SN(v1, v2)
#endif
#define URLC_TRC_RETRANSMIT_AM_SN_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x083D, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_TRANSMIT_AM_CTRL(v1, v2, v3) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x093D, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_TRANSMIT_AM_CTRL(v1, v2, v3)
#endif
#define URLC_TRC_TRANSMIT_AM_CTRL_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x093D, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_TRANSMIT_UM_SN(v1) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A3D, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_TRANSMIT_UM_SN(v1)
#endif
#define URLC_TRC_TRANSMIT_UM_SN_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A3D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define URLC_TRC_TRANSMIT_DUMMY_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B3D, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_NOTIFY_SETUP(v1) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C3D, (unsigned short)(v1)));\
	} while(0)
#else
	#define URLC_TRC_NOTIFY_SETUP(v1)
#endif
#define URLC_TRC_NOTIFY_SETUP_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C3D, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_NOTIFY_RELEASE(v1) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0D3D, (unsigned short)(v1)));\
	} while(0)
#else
	#define URLC_TRC_NOTIFY_RELEASE(v1)
#endif
#define URLC_TRC_NOTIFY_RELEASE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0D3D, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_ACTIVATE_TX(v1, v2) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0E3D, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_ACTIVATE_TX(v1, v2)
#endif
#define URLC_TRC_ACTIVATE_TX_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0E3D, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_ACTIVATE_TX_RES(v1, v2) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F3D, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define URLC_TRC_ACTIVATE_TX_RES(v1, v2)
#endif
#define URLC_TRC_ACTIVATE_TX_RES_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F3D, (unsigned short)(v1)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define URLC_TRC_ZERO_CTRL(v1) do {\
		if(URLC_Trace_Filter[0]==1 && (URLC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x103D, (short)(v1)));\
	} while(0)
#else
	#define URLC_TRC_ZERO_CTRL(v1)
#endif
#define URLC_TRC_ZERO_CTRL_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x103D, (short)(v1)))
