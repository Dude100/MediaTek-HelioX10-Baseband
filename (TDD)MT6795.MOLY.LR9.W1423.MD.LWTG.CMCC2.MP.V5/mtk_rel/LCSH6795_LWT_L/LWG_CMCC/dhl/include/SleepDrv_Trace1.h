...
#include "L1Trc.h"
	...
	#define SLEEPDRV_DBG_CHECK_SM_CALLER(v1, v2, v3, v4, v5) do {\
		if(SleepDrv_1_Trace_Filter[0]==1 && (SleepDrv_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_2S(0x0045, (short)(v3)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	#define SLEEPDRV_DBG_CHECK_SM_CALLER(v1, v2, v3, v4, v5)
#endif
#define SLEEPDRV_DBG_CHECK_SM_CALLER_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_2S(0x0045, (short)(v3)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v4), (unsigned long)(v5))

#if defined(L1_CATCHER)
	#define SLEEPDRV_DBG_CHECK_SM_LOCKER(v1, v2) do {\
		if(SleepDrv_1_Trace_Filter[0]==1 && (SleepDrv_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0145, (short)(v1)), (unsigned long)(v2));\
	} while(0)
#else
	#define SLEEPDRV_DBG_CHECK_SM_LOCKER(v1, v2)
#endif
#define SLEEPDRV_DBG_CHECK_SM_LOCKER_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0145, (short)(v1)), (unsigned long)(v2))

#if defined(L1_CATCHER)
	#define SLEEPDRV_DBG_CHECK_MODEM_LOCKER(v1) do {\
		if(SleepDrv_1_Trace_Filter[0]==1 && (SleepDrv_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0245, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define SLEEPDRV_DBG_CHECK_MODEM_LOCKER(v1)
#endif
#define SLEEPDRV_DBG_CHECK_MODEM_LOCKER_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0245, (unsigned char)(v1), TRC_BOXSTER_PAD))
