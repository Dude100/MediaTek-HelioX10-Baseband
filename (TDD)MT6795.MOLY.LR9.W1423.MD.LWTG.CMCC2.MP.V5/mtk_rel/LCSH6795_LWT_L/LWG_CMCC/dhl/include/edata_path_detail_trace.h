...
#include "L1Trc.h"
	...
	#define ILM_ERT_HISR_IN(v1, v2, v3, v4) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x0011 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ILM_ERT_HISR_DSP_TIMER(v1, v2, v3, v4) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0111 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)((short)(v4))) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define ILM_IN(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0211 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ILM_OUT(v1, v2, v3, v4) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x0311 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ERT_ILM_IN(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_3_word(0x0411 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ERT_ILM_OUT(v1, v2, v3, v4) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_4_word(0x0511 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ENTER_DSP_TIMER_HISR_IN(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0611 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define POLL_CYCLES(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0711 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ENTER_DSP_TIMER_HISR_OUT(v1, v2, v3, v4) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_4_word(0x0811 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define PROTECT(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0911 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_RCV_UL(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x0C11 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
