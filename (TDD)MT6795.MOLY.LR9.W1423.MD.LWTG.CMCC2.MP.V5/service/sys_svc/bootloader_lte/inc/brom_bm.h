 ...
 * removed!
 * removed!
 * SDIO MD DL buffer size reduction - update buffer size in xboot flow
 *
 * removed!
 * removed!
 *
...
#ifdef __UBL__
#define BROM_SDIO_RX_GPD_BUF_SZ 3584	//size used in BL
#else
#define BROM_SDIO_RX_GPD_BUF_SZ 2048	//size used in BROM
#endif
#define BROM_GPD_SIGNATURE	0x7208

#define BROM_AP_MAX_UL_BUF_SZ		128*1024 //AP side max buf 128KB
#define BROM_SDIO_UL_HEAD_SZ		4
#define BROM_MAX_ONE_PKT_SZ			(BROM_SDIO_RX_GPD_BUF_SZ + BROM_SDIO_UL_HEAD_SZ)
#define BROM_MAX_MULTI_UL_PKT_CNT	(BROM_AP_MAX_UL_BUF_SZ/BROM_MAX_ONE_PKT_SZ)
...
extern volatile brom_rgpd_t brom_multi_rgpd[BROM_MAX_MULTI_UL_PKT_CNT];
