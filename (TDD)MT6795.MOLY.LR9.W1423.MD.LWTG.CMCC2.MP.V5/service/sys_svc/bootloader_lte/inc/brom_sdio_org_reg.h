#ifndef __HIF_ORG_SDIO_H__
#define __HIF_ORG_SDIO_H__
...
#define BASE_ADDR_PERIAHB  BASE_ADDR_MDPERIAPB
#define BASE_ADDR_CISCC BASE_ADDR_SDCTL_CISCC
...
#define ORG_SDIO_CAPABILITY_BASE    (volatile kal_uint32 *)(BASE_ADDR_CISCC+0xCC00)
  #define SDIO_CAPABILITY_BASE_0      (volatile kal_uint32 *)(BASE_ADDR_CISCC+0xCC00)
  #define SDIO_CAPABILITY_BASE_1      (volatile kal_uint32 *)(BASE_ADDR_CISCC+0xCC04)
  #define SDIO_CAPABILITY_BASE_2      (volatile kal_uint32 *)(BASE_ADDR_CISCC+0xCC08)
  #define SDIO_CAPABILITY_BASE_3      (volatile kal_uint32 *)(BASE_ADDR_CISCC+0xCC0C)
...
#define ORG_SDIO_HCSDCR				(volatile kal_uint32 *)(ORG_SDIO_BASE+0x0018)
...
#define ORG_SDIO_HWFTSR0                        (volatile kal_uint32 *)(ORG_SDIO_BASE+0x0200)
#define ORG_SDIO_HWFTSR1                        (volatile kal_uint32 *)(ORG_SDIO_BASE+0x0204)


/*  Test mode related register  */
#define ORG_SDIO_HGTMTCR            (volatile kal_uint32 *)(ORG_SDIO_BASE+0x0030)	
#define ORG_SDIO_HGTMCR             (volatile kal_uint32 *)(ORG_SDIO_BASE+0x0034)	
#define ORG_SDIO_HGTMDPCR0          (volatile kal_uint32 *)(ORG_SDIO_BASE+0x0038)	
#define ORG_SDIO_HGTMDPCR1          (volatile kal_uint32 *)(ORG_SDIO_BASE+0x003C)
...
/**
 *	@brief	Card Capability Definition
 */ 

#define S8B_DEF      (0x1<<8)
#define SSDR50_DEF   (0x1<<9)
#define SSDR104_DEF  (0x1<<10)
#define SDDR50_DEF   (0x1<<11)
#define SDTA_DEF     (0x1<<12)
#define SDTC_DEF     (0x1<<13)
#define SDTD_DEF     (0x1<<14)
#define SAI_DEF      (0x1<<15)
...
#define ORG_SDIO_RX0_LEN_FIFO_AVAIL_CNT			0x000000FF
...
/* Only use in ORG_SDIO_HWFTSR */
#define ORG_SDIO_TQ0_CNT_NOW	    0x000000FF
#define ORG_SDIO_TQ1_CNT_NOW	    0x0000FF00
#define ORG_SDIO_TQ2_CNT_NOW	    0x00FF0000
#define ORG_SDIO_TQ3_CNT_NOW	    0xFF000000
#define ORG_SDIO_TQ4_CNT_NOW	    0x000000FF
#define ORG_SDIO_TQ5_CNT_NOW	    0x0000FF00
#define ORG_SDIO_TQ6_CNT_NOW	    0x00FF0000
#define ORG_SDIO_TQ7_CNT_NOW	    0xFF000000

#define ORG_SDIO_TQ_CNT_NOW_n(q_num)			(volatile kal_uint8 *)(((kal_uint32)ORG_SDIO_HWFTSR0) + (0x01 * q_num))


#define ORG_SDIO_CLK_DLY_SEL     (0x1F)
#define ORG_SDIO_CLK_DLY_EN      (0x1 << 7)
#define ORG_SDIO_CMD_O_DLY       (0x1F << 16)
#define ORG_SDIO_CMD_OE_DLY_EN   (0x1 << 22)
#define ORG_SDIO_CMD_O_DLY_EN    (0x1 << 23)
#define ORG_SDIO_DAT_O_DLY       (0x1F)
#define ORG_SDIO_DAT_OE_DLY_EN   (0x1 << 6)
#define ORG_SDIO_DAT_O_DLY_EN    (0x1 << 7)
