...
#if ( defined(__SV5_ENABLED__) ||defined(__SV5X_ENABLED__) ) && defined(__NFI_SHARED_DRV__) && defined(__MINI_BOOTLOADER__)
...
#if ( defined(__SV5_ENABLED__) ||defined(__SV5X_ENABLED__) ) || defined(__NFI_VERSION3__) || defined(__NFI_VERSION3_1__)
...
#if defined(__USE_NFI_SHARED_DRV__)
#include "nfi_sw.h"
#elif ( defined(__SV5_ENABLED__) ||defined(__SV5X_ENABLED__) ) || defined(__NFI_VERSION3__) || defined(__NFI_VERSION3_1__)
