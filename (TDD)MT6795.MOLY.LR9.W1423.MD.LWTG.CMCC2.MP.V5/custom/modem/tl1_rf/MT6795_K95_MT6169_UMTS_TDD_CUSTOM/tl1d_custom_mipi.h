...
T_MIPI_CUSTOMIZATION_STRUCT AST_TL1_RFFE_PARAMETER_DEFAULT[] ={
{
	...
	//MIPI Data table
	{
			//Rx On Data
			{
				...
				{  /*  1 */  MIPI_ASM     | (MIPI_PORT1<<15),                0x0900,                0x0B40,                0x0700,                0x0B40},
			...
			//Tx On Data
			{
				...
				{  /*  1 */  MIPI_ASM     | (MIPI_PORT1<<15),                0x3800,                0x0B5C,                0x3800,                0x0B5C},
				{  /*  2 */  MIPI_ASM     | (MIPI_PORT1<<15),                0x0600,                0x0B40,                0x0500,                0x0B40},
				{  /*  3 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
				{  /*  4 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
				{  /*  5 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
				{  /*  6 */  DATA_NULL    |          (0<<15),                     0,                     0,                     0,                     0},
	...
	{		  
			{
				...
				{  /*  2 */  MIPI_PA      | (MIPI_PORT0<<15),	               0xAB00,                0x0F42,                0xFE00,                0x0F42},//FOR PA HIGH MODE
				{  /*  3 */  MIPI_PA      | (MIPI_PORT0<<15),	               0x3400,                0x0F43,                0x1000,                0x0F43},//FOR PA HIGH MODE
		  ...
		  },
			{
				...
				{  /*  2 */  MIPI_PA      | (MIPI_PORT0<<15),	               0xB800,                0x0F42,                0xB800,                0x0F42},//FOR PA MIDDLE MODE
				{  /*  3 */  MIPI_PA      | (MIPI_PORT0<<15),	               0x0000,                0x0F43,                0x0000,                0x0F43},//FOR PA MIDDLE MODE
