...
*                  MML1_CUSTOM_BARCODE_DETECTION_ID                                                            
*****************************************************************************/
#define MML1_CUSTOM_FIRST_INDEX            (MML1_CUSTOM_ADC_DETECTION_ID) //MT6795 SP use ADC for DRDI detection
...
*****************************************************************************/
#define MML1_CUSTOM_ADC_LEVEL_TOTAL          (4) // HW voltage layout to 0; 0.9; 1.8V for 3 DRDI set ; choose 4 ADC level for range allocation.
...
*               ex: 7 => 2^7 = 128
*****************************************************************************/
#define MML1_CUSTOM_ADC_MEAS_COUNT_2_ORDER   (4) //2^4 = 16
...
*****************************************************************************/
#define MML1_CUSTOM_ADC_BITS                            (15)      // MT6795 PMIC 6331 AUX ADC 15 bit (1/32768) per step
...
*****************************************************************************/
#define MML1_CUSTOM_ADC_MAX_INPUT_VOLTAGE               (3200000) // uV   // MT6795 PMIC 6331 ADC max detect voltage 3.2V
