...
#if defined(MT6595)
			// input disable
//			DRV_WriteReg32(0xA0005910, DRV_Reg32(0xA0005910) & ~0x08);
#endif
...
#if defined(MT6595)
			// input disable
//			DRV_WriteReg32(0xA0005910, DRV_Reg32(0xA0005910) & ~0x40);
#endif
...
PREFER_ORI:
	...
	*/
	...
	if(hw_cb->simInterface)	// SIM2
		DRV_WriteReg32(0xA0005E50, DRV_Reg32(0xA0005E50) & 0xFFFFF777);
	else			// SIM1
		DRV_WriteReg32(0xA0005E40, DRV_Reg32(0xA0005E40) & 0xFFFFF777);
#endif
...
// abnormal card
				...
				usim_dcb->ts_hsk_en = KAL_TRUE;
				if(hw_cb->simInterface)	// SIM2
					DRV_WriteReg32(0xA0005E50, DRV_Reg32(0xA0005E50) | 0x00000888);
				else			// SIM1
					DRV_WriteReg32(0xA0005E40, DRV_Reg32(0xA0005E40) | 0x00000888);
