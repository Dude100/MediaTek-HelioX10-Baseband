...
MODULE_MSG_BEGIN( MSG_ID_RAC_CODE_BEGIN )
   ...
   MSG_ID_RAC_NWSEL_SET_RECOVERY_SEARCH_TIMER_CNF,
   MSG_ID_RAC_NWSEL_GET_RECOVERY_SEARCH_TIMER_CNF,
...
#endif /* __SGLTE__ */    
#endif /* __LTE_RAT__ */
   MSG_ID_RAC_NWSEL_RFOFF_CNF,
   MSG_ID_RAC_NWSEL_SET_ROAMING_MODE_CNF, /* 3G */
   MSG_ID_RAC_NWSEL_SET_PREFER_RAT_CNF,
   MSG_ID_RAC_NWSEL_SET_RAT_MODE_CNF,
   MSG_ID_RAC_NWSEL_PLMN_SEARCH_CNF,
   MSG_ID_RAC_NWSEL_PLMN_LIST_CNF,
   MSG_ID_RAC_NWSEL_PLMN_LIST_STOP_CNF,
   MSG_ID_RAC_NWSEL_CSG_LIST_CNF,
   MSG_ID_RAC_NWSEL_CSG_LIST_STOP_CNF,
   MSG_ID_RAC_NWSEL_PLMN_STATUS_IND,
   MSG_ID_RAC_NWSEL_SUSPEND_STATUS_IND,
   MSG_ID_RAC_NWSEL_PLMN_LIST_IND,
   MSG_ID_RAC_NWSEL_SUSP_RESU_UPDATE_CNF,
#ifdef __SGLTE__
   MSG_ID_RAC_NWSEL_MMDC_CAMP_ON_STATUS_IND,
   MSG_ID_RAC_GAS_RAT_MODE_OR_FLIGHT_MODE_IND,
   MSG_ID_RAC_NWSEL_PLMN_SEARCH_ABORT_CNF,
   MSG_ID_RAC_NWSEL_MMDC_PLMN_LOSS_IND,
#endif /* __SGLTE__ */
   MSG_ID_RAC_NWSEL_IMS_SERVICE_IND,
   MSG_ID_RAC_NWSEL_RESTART_CLEAR_CODE_33_PROC_IND,
   MSG_ID_RAC_NWSEL_CS_DOMAIN_AVAILABILITY_IND,

   MSG_ID_RAC_CODE_END = MSG_ID_RAC_NWSEL_CS_DOMAIN_AVAILABILITY_IND,
...
MODULE_MSG_BEGIN( MSG_ID_ATCI_CODE_BEGIN )
    ...
    MSG_ID_ATCI_CODE_END = MSG_ID_ATCI_UT_UART_INPUT_IND,
